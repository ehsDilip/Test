...
$request['TransactionDetail'] = array('CustomerTransactionId' => '*** Reprint Ground Close Documents Request using PHP ***');
...
try {
	...
	$response = $client ->reprintGroundCloseDocuments($request);
