...
class youTube
{
	...
	public function parseVideoRow($video)
	{
		...
		$RKT_video = split(":",$RKT_videoId);
		
		$html .= '<div>';
			$html .= '<iframe width="420" height="315" src="https://www.youtube.com/embed/'.$RKT_video[3].'" frameborder="0" allowfullscreen></iframe><br/>';
		$html .= $RKT_videoTitleFull;
		$html .= '</div>';
