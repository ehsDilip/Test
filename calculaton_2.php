...
function match_detail($datapath, $teamid) {
    ...
    if ($detail['datapath'] == $datapath && count($detail) > 0) {
        ...
        if($team1 == $teamid){
            ...
            $team1_sqd_array = $detail['team2']['squad'];
            $team2_sqd_array = $detail['team1']['squad'];
        }
...
echo "<pre>";
$match_details = match_detail('2015/2015_AUS_IND_ENG/AUS_ENG_JAN23/', '9');
